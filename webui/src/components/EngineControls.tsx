...
export function EngineControls({ runtime, onStart, onStop, busy = false }: Props) {
  ...
  return <section className="panel engine-controls" aria-labelledby="engine-title">
    <div className="runtime-layout"><div className="runtime-actions">
    ...
    </div><SystemHealth health={runtime.system_health ?? { cpu_percent: null, memory_percent: null, status: "UNAVAILABLE", explanation: "System metrics are unavailable." }} /></div>
  </section>;
}
